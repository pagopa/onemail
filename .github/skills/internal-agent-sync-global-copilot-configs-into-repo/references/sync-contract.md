...
- Preserve approved repo-specific preserved-asset exceptions under mirrored categories and surface them in the plan or final report.
...
- Delete target-owned assets inside mirrored categories during `apply` unless they are covered by `local-*` or an approved repo-specific preserved-asset exception.
...
- preserved consumer-owned assets, including `local-*`, approved repo-specific preserved-asset exceptions, and consumer-local GitHub instructions overrides status
